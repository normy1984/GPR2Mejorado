...
/*
            $.ajax({
                ...
                success: (response) => {
                    ...
                    console.log('Es Blob:', response instanceof Blob);
    ...
    fetch('{{ route('export.budget.progress.project_tracking.execution', ['id' => $projectId]) }}')
        .then(response => {
            if (!response.ok) {
        ...
        .finally(() => {
            ...
            let table = build_datatable($('#tracking_project_tb'), {
                ...
                ajax: {
                    ...
                    "dataSrc": (response) => {
                        //alert("Antes de enviar la solicitud AJAX");
