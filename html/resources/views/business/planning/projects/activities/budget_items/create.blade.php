    ...
    <div class="modal-content" id="myModal">
        ...
        @if(isset($activityType) && $activityType === $BudgetItem::ACTIVITY_TYPE_OPERATIONAL)
            <form method="post"
                ...
                @else
                    <form method="post" action="{{ route('store.create.items.activities.projects.plans_management', ['activityId' => $activity->id]) }}"
                                        ...
                                        <table class="table table-bordered detail-table">
                                            ...
                                            @if(isset($activityType) && $activityType === $BudgetItem::ACTIVITY_TYPE_OPERATIONAL)
                                                <tr>
                                                    ...
                                                    <td>@isset($activity->subprogram->parent->area)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>@isset($activity->executingUnit)
                                            ...
                                            @else
                                                <tr>
                                                    <td>{{ trans('budget_item.labels.program') }}</td>
                                                    <td>@isset($activity->component->project->subprogram)
                                                            {{ $activity->component->project->subprogram->parent->code }}
                                                        @endisset</td>
                                                    <td>@isset($activity->component->project->subprogram)
                                                            {{ $activity->component->project->subprogram->parent->description }}
                                                        @endisset</td>
                                                </tr>
                                                ...
                                                <tr>
                                                    <td>{{ trans('budget_item.labels.sub_program') }}</td>
                                                    <td>@isset($activity->component->project->subProgram)
                                                            {{ $activity->component->project->subProgram->code }}
                                                        @endisset</td>
                                                    <td>@isset($activity->component->project->subProgram)
                                                            {{ $activity->component->project->subProgram->description }}
                                                        @endisset</td>
                                                </tr>

                                                <tr>
                                                    <td>{{ trans('budget_item.labels.project') }}</td>
                                                    <td>@isset($activity->component->project)
                                                            {{ $activity->component->project->cup }}
                                                        @endisset</td>
                                                    <td>@isset($activity->component->project)
                                                            {{ $activity->component->project->name}}
                                                        @endisset</td>
                                                </tr>
                                                ...
                                                <tr>
                                                    <td>{{ trans('budget_item.labels.executingUnit') }}</td>
                                                    <td>@isset($activity->component->project->executingUnit)
                                                            {{ $activity->component->project->executingUnit->code }}
                                                        @endisset</td>
                                                    <td>@isset($activity->component->project->executingUnit)
                                                            {{ $activity->component->project->executingUnit->name }}
                                                        @endisset</td>
                                                </tr>
