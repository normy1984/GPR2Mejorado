...
@php
    $wiki = session('wiki');
    $wikiUrl = $wiki['url'] ?? '#';
    $wikiPrioritization = $wiki['modules']['gxr']['planning']['prioritization']['index'] ?? '';// session('wiki')['modules']['gxr']['planning']['prioritization']['index']
@endphp
<div>
    <div class="page-title">
        <div class="col-md-11 col-sm-11 col-xs-11">
            <h3>{{ trans('projects.title') }}
                <small>{{ trans('project_review.title').'prueba' }}</small>
            </h3>
        </div>
        <div class="col-md-1 col-sm-1 col-xs-1">

            <a href="{{ $wikiUrl . $wikiPrioritization  }}" target="_blank" data-toggle="tooltip" data-placement="top"
                ...
                <div class="x_content">
                    ...
                    <table class="table table-striped" id="projects_review_tb">
                        ...
                        <tr>
                            ...
                            <th>{{ trans('projects.labels.responsibleUnit')."Aqui" }}</th>
