{{-- DEBUG --}}
<pre>
    Option: {{ var_export($option ?? 'NO_OPTION_SET', true) }}
</pre>
...
<div>
    ...
    $wikiUrl = data_get(session('wiki',[]), 'url');
    $budgetPlanningPath = data_get(session('wiki', []), 'modules.gxr.reports.budget_planning');
@endphp

@if($wikiUrl && $budgetPlanningPath)
    <a href="{{ $wikiUrl . $budgetPlanningPath }}" target="_blank"
       data-toggle="tooltip" data-placement="top"
       data-original-title="{{ trans('app.labels.info') }}">
        <i class="fa fa-info-circle blue mt-3 mb-3 info-link" role="button"></i>
    </a>
@endif
        <!--    <a href="{{ session('wiki')['url'] . session('wiki')['modules']['gxr']['reports']['budget_planning']}}" target="_blank" data-toggle="tooltip" data-placement="top"
               data-original-title="{{ trans('app.labels.info') }}">
                <i class="fa fa-info-circle blue mt-3 mb-3 info-link" role="button"></i>
            </a>-->
        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="col-md-4 col-sm-4 col-xs-12 mb-0">
                                   @if(isset($executingUnits) && count($executingUnits))
    ...
    <div class="alert alert-warning">
        {{ trans('reports.exceptions.executing_units_not_found') }}
    </div>
@endif
                            </div>
    ...
    @if(isset($option) && $option === 'HAS_VIEW')
        <div class="row"><!--\App\Models\Business\Plan::HAS_VIEW-->
