                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                            <li>
                                                                                                                                                                                                                                                <label>
                                                                                                                                                                                                                                                    <input
                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                        @if(!empty($permission7['allowed'])) checked @endif/>
                                                                                                                                                                                                                                                    {{ $permission7['label'] ?? '' }}
                                                                                                                                                                                                                                                </label>
                                                                                                                                                                                                                                            </li>
                                                                                                                                                                                                                                        @endforeach
                                                                                                                                                                                                                ...
                                                                                                                                                                                                                @else
                                                                                                                                                                                                                    <label>
                                                                                                                                                                                                                        <input
                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                            value="{{ $key6 }}"
                                                                                                                                                                                                                            class="js-switch js-check-permission"
                                                                                                                                                                                                                            @if(!empty($permission6['allowed'])) checked @endif/>
                                                                                                                                                                                                                        {{ $permission6['label'] ?? '' }}
                                                                                                                                                                                                                    </label>
                                                                                                                                                                                                                @endif
                                                                                                                                                                                                            </li>
                                                                                                                                                                                ...
                                                                                                                                                                                @else
                                                                                                                                                                                    <label>
                                                                                                                                                                                        <input
                                                                                                                                                                                            ...
                                                                                                                                                                                            value="{{ $key5 }}"
                                                                                                                                                                                            class="js-switch js-check-permission"
                                                                                                                                                                                            @if(!empty($permission5['allowed'])) checked @endif/>
                                                                                                                                                                                        {{ $permission5['label'] ?? '' }}
                                                                                                                                                                                    </label>
                                                                                                                                                                                @endif
                                                                                                                                                                            </li>
                                                                                                                                                ...
                                                                                                                                                @else
                                                                                                                                                    <label>
                                                                                                                                                        <input type="checkbox"
                                                                                                                                                               value="{{ $key4 }}"
                                                                                                                                                               class="js-switch js-check-permission"
                                                                                                                                                               @if(!empty($permission4['allowed'])) checked @endif/>
                                                                                                                                                        {{ $permission4['label'] ?? '' }}
                                                                                                                                                    </label>
                                                                                                                                                @endif
                                                                                                                                            </li>
                                                                                                                ...
                                                                                                                @else
                                                                                                                    <label>
                                                                                                                        <input type="checkbox"
                                                                                                                               class="js-switch js-check-permission"
                                                                                                                               value="{{ $key3 }}"
                                                                                                                               @if(!empty($permission3['allowed'])) checked @endif/>
                                                                                                                        {{ $permission3['label'] ?? '' }}
                                                                                                                    </label>
                                                                                                                @endif
                                                                                                            </li>
                                                                                ...
                                                                                @else
                                                                                    <label>
                                                                                        <input type="checkbox"
                                                                                               class="js-switch js-check-permission"
                                                                                               value="{{ $key2 }}"
                                                                                               @if(!empty($permission2['allowed'])) checked @endif/>
                                                                                        {{ $permission2['label'] ?? '' }}
                                                                                    </label>
                                                                                @endif
                                                                            </li>
