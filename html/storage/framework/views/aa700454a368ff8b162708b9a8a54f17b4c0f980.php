...
} elseif ($_instance->childHasBeenRendered('NYeivv3')) {
    $componentId = $_instance->getRenderedChildComponentId('NYeivv3');
    $componentTag = $_instance->getRenderedChildComponentTagName('NYeivv3');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('NYeivv3');
} else {
    $response = \Livewire\Livewire::mount('notifications');
    $html = $response->html();
    $_instance->logRenderedChild('NYeivv3', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
 <?php echo $__env->renderComponent(); ?>
...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
<?php /**PATH /var/www/html/vendor/filament/filament/resources/views/components/layouts/card.blade.php ENDPATH**/ ?>