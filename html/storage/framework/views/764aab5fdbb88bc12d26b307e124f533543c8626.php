...
<script>
    $(() => {
        ...
        // Add data
        chart_type.dataSource.url = "<?php echo e(route('category.budget.dashboard.control_panel', ['type' => 2, 'category' => 'type']), false); ?>";
...
</script><?php /**PATH /var/www/html/resources/views/dashboard/planning/components/budget/incomes/chart_2.blade.php ENDPATH**/ ?>