<div class="modal-content">
    <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel"><?php echo e(trans('income.labels.import'), false); ?></h4>
    </div>

    <div class="modal-body">
        <form role="form" action="<?php echo e(route('load.import.index.income.budget.plans_management'), false); ?>"
        ...
        <div class="alert alert-danger fw-b mt-3" role="alert">
            <?php echo e(trans('income.messages.confirm.import'), false); ?>
...
</script><?php /**PATH /var/www/html/resources/views/business/planning/income/import.blade.php ENDPATH**/ ?>