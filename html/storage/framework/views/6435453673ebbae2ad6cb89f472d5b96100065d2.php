...
<div <?php echo e($attributes->class(['filament-forms-field-wrapper']), false); ?>>
    <?php if($label && $labelSrOnly): ?>
        <label for="<?php echo e($id, false); ?>" class="sr-only">
...
<?php endif; ?>
                <?php elseif($labelPrefix): ?>
                    <?php echo e($labelPrefix, false); ?>

                <?php elseif($labelSuffix): ?>
                    <?php echo e($labelSuffix, false); ?>
...
<?php $component->withAttributes(['action' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($hintAction),'color' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($hintColor),'icon' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($hintIcon)]); ?>
                        <?php echo e(filled($hint) ? ($hint instanceof \Illuminate\Support\HtmlString ? $hint : \Illuminate\Support\Str::of($hint)->markdown()->sanitizeHtml()->toHtmlString()) : null, false); ?>
...
<?php $component->withAttributes([]); ?>
                <?php echo e($errors->first($statePath) ?: ($hasNestedRecursiveValidationRules ? $errors->first("{$statePath}.*") : null), false); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                <?php echo e($helperText instanceof \Illuminate\Support\HtmlString ? $helperText : \Illuminate\Support\Str::of($helperText)->markdown()->sanitizeHtml()->toHtmlString(), false); ?>
