...
<?php if($tag === 'button'): ?>
    <button
        <?php if($keyBindings): ?>
            x-mousetrap.global.<?php echo e(collect($keyBindings)->map(fn (string $keyBinding): string => str_replace('+', '-', $keyBinding))->implode('.'), false); ?>

        <?php endif; ?>
        <?php if($tooltip): ?>
            x-tooltip.raw="<?php echo e($tooltip, false); ?>"
        <?php endif; ?>
        ...
        <?php echo e($attributes->class($buttonClasses), false); ?>
...
<?php endif; ?>
                ...
                <span x-show="isUploadingFile" x-cloak>
                    <?php echo e(__('filament-support::components/button.messages.uploading_file'), false); ?>
...
<?php endif; ?>
<?php /**PATH /var/www/html/vendor/filament/support/resources/views/components/button.blade.php ENDPATH**/ ?>