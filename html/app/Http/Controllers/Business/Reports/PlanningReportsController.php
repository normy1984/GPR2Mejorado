...
class PlanningReportsController extends Controller
{
    ...
    public function pacExportXls(int $fiscalYearId)
    {
      ...
      return Excel::download(new DefaultReportExport('business.reports.planning.pac.pac_table',$data,"Plan Anual de Compras"), trans('reports.pac.title') . '.xlsx');
    }
...
// Construye los datos a pasar a la vista
    $viewData = [
        'rows' => $items,
        ...
        'levelDescription' => $data['levelDescription']
          ...
          return Excel::download(new DefaultReportExport(
        'business.reports.tracking.budget_card.budget_card_table',
        $viewData,"Cedula Presupuestaria"),
       trans('reports.budget_card.report_file_name').'.xlsx'
    );
           }
