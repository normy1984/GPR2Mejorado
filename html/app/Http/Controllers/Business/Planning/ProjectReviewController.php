...
class ProjectReviewController extends Controller
{
    ...
    {
        try {
             \Illuminate\Support\Facades\Log::info('👉 Entró al método index() de PacController');
    ...
    public function data()
    {
               \Illuminate\Support\Facades\Log::info('👉 Entró al método index() de PacController');
        try {
            $result= $this->projectsReviewProcess->data();
              \Illuminate\Support\Facades\Log::info('Prioritization data en review:', [
            'result' => $result
        ]);
            return $result;
